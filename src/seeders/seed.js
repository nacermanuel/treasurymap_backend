...
const companies = [
 ...
 },
 {
  ...
  "productName": "AiVidens-Insights, Collection, Payment Forecast, Credit Limit",
  "productVersion": "Insights: segments debt portfolios according to payment behaviors and risksCollection: organizes and manages collection teams efforts (selects and prioritizes customers dynamically)Payment Forecast: predicts when customers will pay their invoices and allows customers to add their own estimated payment dates for better cash forecastingCredit Limits: calculates dynamically new limits according to your own formulas and proposes them for validation.  ",
  "logo": "https://res.cloudinary.com/dq7aof6vb/image/upload/v1705188755/category-11-logo-2_mtab9d.png",
  "keywords": ["Aividens","Receivables"," Working Capital"," Predictions"," Payment","AI","Artificial Intelligence"," Credit Limit"," Collection"],
  "live": true,
  "maincategory": [11]
 },
 {
 ...
 },
 {
  ...
  "keywords": ["Finologee","Support PFS"," SaaS"," Dashboard"," Risk management"," Cash Management"," Multi-Bank"],
  "live": true,
  "maincategory": [13]
 },
 {
