...
const subCategories = [
  ...
  {
    name: "Other financial instruments management",
  },
  {
...
const companies = [
  ...
  },
  {
    ...
    productName: "SGX FX ",
    productVersion:
      "SGX FX brings innovation to the global FX ecosystem - from accessing wide liquidity pools in both OTC and Futures markets, to customising cutting-edge workflow solutions for the buy and sell-side, our comprehensive offerings are designed to help you stay ahead of the curve.",
  ...
  },
  {
    name: "Aividens",
    description:
      "AiVidens' Receivables Management Solution, allows companies to leverage data for Financial Success: Mastering Credit & Collection Management Strategies as well as Payment Forecasting.We demystify the use of data and algorithms, reveal new strategies for improving your working capital and allow you to quickly start with the data you have.With our solution, companies discover new methods to reducing risk and overdue, improving credit and collection management operational efficiency and optimizing cash forecasting. Expert employees gain the required knowledge that helps them contribute to the financial well-being of their company. ",
    creationDate: "2019",
    turnover: 0,
    employees: "N/A",
    location: "Belgium/Brussels",
    userId: 90,
    companyWebsite: "https://aividens.com/",
    companyOffices: [17, 60, 103, 126, 164],
    companyCategories: [11, 10],
    companySubcategories: [1, 7, 8, 17, 21, 22, 14, 25],
    productName:
      "AiVidens-Insights, Collection, Payment Forecast, Credit Limit",
    productVersion:
      "Insights: segments debt portfolios according to payment behaviors and risksCollection: organizes and manages collection teams efforts (selects and prioritizes customers dynamically)Payment Forecast: predicts when customers will pay their invoices and allows customers to add their own estimated payment dates for better cash forecastingCredit Limits: calculates dynamically new limits according to your own formulas and proposes them for validation.  ",
  ...
  },
  {
    ...
    productVersion:
      "As Convista, we are one of the leading consultancies for transformation. We support you in designing and implementing new business processes and create end-to-end solutions for your SAP as well as IT projects.",
    logo: "https://res.cloudinary.com/dq7aof6vb/image/upload/v1705890665/convista-Logo-RGB_pbpcdo.png",
    keywords: ["Convista"],
    live: true,
    maincategory: [13],
  },
  ...
  },
  {
    ...
    productName: "N/A",
    productVersion: "N/A",
    logo: "https://res.cloudinary.com/dq7aof6vb/image/upload/v1705891846/blue-prism-logo_x2eive.png",
    keywords: ["Blueprism"],
    live: true,
    maincategory: [14],
  },
  ...
  },
  {
    ...
    productName: "N/A",
    productVersion: "N/A",
    logo: "https://res.cloudinary.com/dq7aof6vb/image/upload/v1705892253/pega-logo_fdveqc.png",
    keywords: ["Pega"],
    live: true,
    maincategory: [14],
  },
  {
    ...
    productName: "N/A",
    productVersion: "N/A",
    logo: "https://res.cloudinary.com/dq7aof6vb/image/upload/v1705890997/RStudio-Logo-resized_pocs4p.png",
    keywords: ["R Studio"],
    live: true,
    maincategory: [14],
  },
  ...
  },
  {
    ...
    productName: "N/A",
    productVersion: "N/A",
    logo: "https://res.cloudinary.com/dq7aof6vb/image/upload/v1705679780/e18fb40b-b819-4907-a10a-a6ad50841833-utsit%20bleu%20fond%20transp.png.png",
    keywords: ["Utsit"],
    live: true,
    maincategory: [4],
  },
  ...
  },
  {
    ...
    userId: 122,
    companyWebsite: "www.transfermate.com",
    companyOffices: [
      9, 26, 31, 64, 80, 107, 114, 127, 139, 157, 185, 186, 187, 60,
    ],
    companyCategories: [5],
    companySubcategories: [3],
    productName: "TransferMate Global Payments",
    productVersion:
      "TransferMate Global Payments is the world`s leading provider of B2B payments infrastructure-as-a-service. Over the past decade, TransferMate has built the largest non-bank network in the world that allows businesses and individuals to make cross-border payments as easily as if making a domestic funds transfer. Over €18 billion flowed through TransferMate`s in 2022, up from €7.2billion in 2021, showing an 86% year on year growth. Continuous growth and innovation for a decade culminated in TransferMate`s unicorn status in May 2022. We offer payables, receivables, and stored value solutions. By combining our global, regulated payments network and our technology, businesses can pay and receive across the world easier, faster, more transparently, and more cost-effectively than through traditional methods. Our Global Accounts solution allows businesses to hold, pay and receive multiple currencies on a single platform, allowing them to trade globally like they had a local banking presence. Our API integrations allow partners to ‘upgrade their payment` engine and offer their end-users the same benefits as our direct clients. We are now integrated into banks, FIs, fintech`s, ERPs, BSMs, Procurement, Accounting and E-Commerce platforms across the world. Partners include SAP Concur, Coupa Pay, Sage, Quickbooks, AccountsIQ, Wells Fargo, and Barclays.",
    logo: "https://res.cloudinary.com/dq7aof6vb/image/upload/v1705210831/category-5-logo-13_km86tu.png",
    keywords: ["TransferMate Global Payments"],
    live: true,
    maincategory: [5],
  },
  {
  ...
  },
  {
    ...
    productName: "N/A",
    productVersion: "N/A",
    logo: "https://res.cloudinary.com/dq7aof6vb/image/upload/v1705894508/FINMETRICS_qvpxfj.png",
    keywords: ["Fm"],
    live: true,
    maincategory: [9],
  },
  {
    ...
    productName: "N/A",
    productVersion: "N/A",
    logo: "https://res.cloudinary.com/dq7aof6vb/image/upload/v1705894508/INTIX_z3acez.png",
    keywords: ["Intix"],
    live: true,
    maincategory: [9],
  },
  ...
  },
  {
    ...
    productName: "N/A",
    productVersion: "N/A",
    logo: "https://res.cloudinary.com/dq7aof6vb/image/upload/v1705895005/QLIKVIEW_falxhi.png",
    keywords: ["Qlik View"],
    live: true,
    maincategory: [9],
  },
    ...
    for (let i = 0; i < companies.length; i++) {
      try {
        ...
        const res = await Articles.create({
          title: "Article 1",
          coverImage:
            "https://res.cloudinary.com/dq7aof6vb/image/upload/v1712617488/86f0f93f-cb12-423c-95ea-45fd26152c25-Capture-decran-2024-04-02-a-15.19.09-720x480.png.png",
